...
class RecommenderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAvailableTournaments = channel.unary_unary(
                '/services.RecommenderService/GetAvailableTournaments',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.TournamentsResponse.FromString,
                )
...
def add_RecommenderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAvailableTournaments': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAvailableTournaments,
                    request_deserializer=service__pb2.Empty.FromString,
                    response_serializer=service__pb2.TournamentsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class RecommenderService(object):
    ...
    @staticmethod
    def GetAvailableTournaments(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/services.RecommenderService/GetAvailableTournaments',
            service__pb2.Empty.SerializeToString,
            service__pb2.TournamentsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
